-- Rotaria City Citizen Client Installer
-- Download and install the Rotaria City citizen client

-- TODO: Replace with your actual GitHub repository URL
local clientUrl = "https://raw.githubusercontent.com/atefMck/RotariaMayoralDashboard/refs/heads/main/build/rotariaClientCitizen.lua"
...
if (args[1] == "-h") or (args[1] == "--help") then
    print("Usage: installClientCitizen.lua [options]")
    print("Options:")
...
if (args[1] == "-q") or (args[1] == "--quick") then
    print("Quick installing Rotaria City citizen client...")
    ...
    local installPath = args[2] or "rotariaClientCitizen.lua"
...
welcomeScreen:addLabel(coloring)
    :setText("Welcome to Rotaria City Citizen Client!")
    :setPosition(2, 2)

welcomeScreen:addLabel(coloring)
    :setWidth("{parent.width - 2}")
    :setAutoSize(false)
    :setText([[Rotaria City Citizen Client allows citizens to view city information and apply for plots without requiring a login.

This installer will help you:
• Download and install the citizen client
...
local installPathInput = configScreen:addInput()
    ...
    :setBackground(colors.black)
    :setForeground(colors.white)
    :setPlaceholder("rotariaClientCitizen.lua")
    :setText("rotariaClientCitizen.lua")
...
local function installClient()
    ...
    if installPath == "" then
        installPath = "rotariaClientCitizen.lua"
    end
    ...
    if runOnStartup then
        ...
        local startupContent = "-- Auto-start Rotaria City Citizen Client\n"
